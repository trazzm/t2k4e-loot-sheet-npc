...
/**
 * @module lootsheetnpct2k4e.Helper.HandlebarsHelper
 *
...
export class HandlebarsHelper {
    ...
    static register() {
        ...
        Handlebars.registerHelper('lootsheetprice', (cost, modifier) => this.lootsheetPrice(cost, modifier));
    ...
    */
     ...
     * @return {number}
     */
    static lootsheetPrice(basePrice, priceModifier = 100) {

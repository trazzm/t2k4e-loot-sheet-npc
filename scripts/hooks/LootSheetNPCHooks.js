...
/**
 * @module lootsheetnpct2k4e.hooks
 *
 * @description
 ...
 *
 */
export class LootsheetNPCHooks {
    ...
    static attachTokenHudButtons(hud) {
        ...
        lsnNav.classList.add('lsnpct2k4e-nav');

        if (game.user.isGM) {
            lsnGMButtonMakeObservable.classList.add('lsnpct2k4e-hud-make-observable', 'control-icon');
    ...
    static _handleMigrations(version = '') {
        ...
        //  */
        // const oldClassName = 'lootsheetnpct2k4e.LootSheet5eNPC',
        //     newClassName = 'lootsheetnpct2k4e.LootSheetNPC5e',
